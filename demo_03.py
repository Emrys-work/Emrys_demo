...
print(book.sheet_names())   # 获取表单名字，返回列表
...
print(sheet.cell_value(0, 0))   # 获取指定单元格中的文本内容

print(sheet.row_values(0))   # 获取第一行的内容放在列表中
print(sheet.col_values(0, 1))   # 获取第一列的内容放在列表中
